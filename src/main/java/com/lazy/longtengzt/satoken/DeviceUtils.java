package com.lazy.longtengzt.satoken;
...
public class DeviceUtils {
    ...
    private static boolean isMiniProgram(String userAgentStr) {
        ...
        return StrUtil.containsIgnoreCase(userAgentStr, "MicroMessenger") && StrUtil.containsIgnoreCase(userAgentStr, "MiniProgram");
    }
    ...
    private static boolean isPad(String userAgentStr) {
        ...
        boolean isAndroidTablet = StrUtil.containsIgnoreCase(userAgentStr, "Android") && !StrUtil.containsIgnoreCase(userAgentStr, "Mobile");

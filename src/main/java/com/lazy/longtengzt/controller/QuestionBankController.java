...
import com.lazy.longtengzt.common.*;
...
import com.lazy.longtengzt.model.dto.questionBank.QuestionBankAddRequest;
import com.lazy.longtengzt.model.dto.questionBank.QuestionBankEditRequest;
import com.lazy.longtengzt.model.dto.questionBank.QuestionBankQueryRequest;
import com.lazy.longtengzt.model.dto.questionBank.QuestionBankUpdateRequest;
...
import com.lazy.longtengzt.model.vo.QuestionBankVO;
import com.lazy.longtengzt.sentinel.SentinelConstant;
...
public class QuestionBankController {
    ...
    @PostMapping("/review")
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> reviewQuestionBank(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        ...
        // 判断是否存在
        ThrowUtils.throwIf(oldQuestionBank == null, ErrorCode.NOT_FOUND_ERROR);
        boolean result = reviewService.doReview(oldQuestionBank, reviewRequest, request);

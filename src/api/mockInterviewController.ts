...
/** listMyMockInterviewVOByPage POST /api/mockInterview/my/list/page/vo */
export async function listMyMockInterviewVoByPageUsingPost(
  body: API.MockInterviewQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageMockInterview_>(
